...
var styleHolder = document.querySelector(".styleHolder");
...
function jumpsound() {
      if(x=1){
            let audio = new Audio("./sounds/mario.mp3").play();
            audio.volume=1;
      }
      else{
            audio.volume=0;
...
var check=setInterval(function(){
      ...
      if(herotop > 465 && herowidth >= 30 && herowidth < 90 && ghostleft <= 90 && ghostleft > 0){
            ...
            hero.style.display="none";    
            let lose = new Audio("./sounds/lose.wav").play();
            // updateLocalStorage();
      }
      ...
      if(herotop < 400 && herotop > 379 && point2left <= 90 && point2left > 40){
            ...
            pointnumber.style.animation="pointnumber 0.5s linear";
            point2.style.display="none";
            let coin2 = new Audio("./sounds/coin.wav").play();
            updateLocalStorage()
            setTimeout(function (){
...
function okkk(){
      ...
      if(input.innerText==" "){
            ...
            function ok(){
                  ...
                  let music1 = new Audio("./sounds/music1.mp3");
...
function style1(){
      ...
      skinHolder1.style.backgroundColor="#26355D";
      skinHolder2.style.backgroundColor="#26355D";
      skinHolder3.style.backgroundColor="#26355D";
      skinHolder4.style.backgroundColor="#26355D";
      skinHolder5.style.backgroundColor="#26355D";
      skinHolder6.style.backgroundColor="#26355D";
}
function style2(){
...
function herocolor1(){
      ...
      store.style.color="white"
      document.getElementById("showcontrols").style.backgroundColor="transparent";
      document.getElementById("style1").style.display="flex";
      document.getElementById("style2").style.display="flex";
      document.getElementById("style3").style.display="flex";
      ...
      document.getElementById("music").style.display="none";
      range.style.display="none";
      styleHolder.style.display="flex";
...
skinHolder1.onclick=function(){
      if(skinHolder1.querySelector("i").style.display=="block"){
            if(currentValue>=150){
            ...
            hero.style.background="linear-gradient(rgb(8, 96, 107),rgb(4, 34, 54))";
            skinHolder1.style.backgroundColor="#FF8F00";
            skinHolder2.style.backgroundColor="#26355D";
            skinHolder3.style.backgroundColor="#26355D";
            skinHolder4.style.backgroundColor="#26355D";
            skinHolder5.style.backgroundColor="#26355D";
            skinHolder6.style.backgroundColor="#26355D";
            herostyle1.style.backgroundColor="#26355D";
            herostyle2.style.backgroundColor="#26355D";
            herostyle3.style.backgroundColor="#26355D";
      }
}
setInterval(function(){
      if(localStorage.getItem("skin1")==0){
            ...
            skinDiv.style.cssText="width:100px;height:100px;background-color:red;";
            // skinHolder.appendChild(skinDiv);
      }else{
...
skinHolder2.addEventListener('click',function(){
      if(skinHolder2.querySelector("i").style.display=="block"){
            if(currentValue>=150){
            ...
            hero.style.background="linear-gradient(rgb(107, 8, 21),rgb(28, 88, 80))";
            skinHolder2.style.backgroundColor="#FF8F00";
            skinHolder1.style.backgroundColor="#26355D";
            skinHolder3.style.backgroundColor="#26355D";
            skinHolder4.style.backgroundColor="#26355D";
            skinHolder5.style.backgroundColor="#26355D";
...
skinHolder3.addEventListener('click',function(){
      if(skinHolder3.querySelector("i").style.display=="block"){
            if(currentValue>=150){
            ...
            hero.style.background="linear-gradient(rgb(255, 223, 175),rgb(155, 154, 255))";
            skinHolder3.style.backgroundColor="#FF8F00";
            skinHolder1.style.backgroundColor="#26355D";
            skinHolder2.style.backgroundColor="#26355D";
            skinHolder4.style.backgroundColor="#26355D";
            skinHolder5.style.backgroundColor="#26355D";
...
skinHolder4.addEventListener('click',function(){
      if(skinHolder4.querySelector("i").style.display=="block"){
            if(currentValue>=150){
            ...
            hero.style.background="linear-gradient(rgb(172, 255, 38),rgb(4, 34, 54))";
            skinHolder4.style.backgroundColor="#FF8F00";
            skinHolder1.style.backgroundColor="#26355D";
            skinHolder2.style.backgroundColor="#26355D";
            skinHolder3.style.backgroundColor="#26355D";
            skinHolder5.style.backgroundColor="#26355D";
...
skinHolder5.addEventListener('click',function(){
      if(skinHolder5.querySelector("i").style.display=="block"){
            if(currentValue>=150){
            ...
            hero.style.background="linear-gradient(rgb(248, 245, 47),rgb(117, 10, 69))";
            skinHolder5.style.backgroundColor="#FF8F00";
            skinHolder1.style.backgroundColor="#26355D";
            skinHolder2.style.backgroundColor="#26355D";
            skinHolder3.style.backgroundColor="#26355D";
            skinHolder4.style.backgroundColor="#26355D";
...
skinHolder6.addEventListener('click',function(){
      if(skinHolder6.querySelector("i").style.display=="block"){
            if(currentValue>=150){
            ...
            hero.style.background="linear-gradient(rgb(78, 77, 78),rgb(3, 5, 7))";
            skinHolder6.style.backgroundColor="#FF8F00";
            skinHolder1.style.backgroundColor="#26355D";
            skinHolder2.style.backgroundColor="#26355D";
            skinHolder3.style.backgroundColor="#26355D";
            skinHolder4.style.backgroundColor="#26355D";
